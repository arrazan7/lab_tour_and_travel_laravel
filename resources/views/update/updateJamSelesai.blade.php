    ...
    <div class="container mt-5">
        ...
        @csrf
            ...
            <div class="mb-3 mt-3">
                ...
                <input type="number" value="{{ $data[0]['hari_ke'] }}" class="form-control" id="hari" name="hari_ke" readonly>
            </div>
            <div class="mb-3 mt-3">
                <label for="destinasi">Destinasi Ke:</label>
                <input type="number" value="{{ $data[0]['destinasi_ke'] }}" class="form-control" id="destinasi" name="destinasi_ke" readonly>
            </div>
            <div class="mb-3 mt-3">
                <label for="jam">Jam Selesai:</label>
                <input type="text" pattern="(?:[01]\d|2[0123]):(?:[012345]\d):(?:00)" value="{{ $data[0]['jam_selesai'] }}" class="form-control" id="jam" placeholder="HH:MM" name="jam_selesai">
            </div>
