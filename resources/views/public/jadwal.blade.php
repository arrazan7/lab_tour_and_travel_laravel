...
@section('content')
<img src="../images/image1.png" class="img-detail">
<section id="price">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <small class="text-neutral">Yogyakarta</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col mt-5 mx-5 d-flex flex-row align-items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#919191" class="bi bi-bus-front-fill" viewBox="0 0 16 16">
                            ...
                            <span class="text-neutral ms-3">14.7 km / 23 menit</span>
                        </div>
                    </div>
                    <div class="outer mb-0 pb-5">
                        <div class="card card-wisata mb-3">
